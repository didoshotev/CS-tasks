...
const checkSmallBuilding = (row, coll) => {
    ...
    const smBuildingCordinates = field.get.buildingCordinates(GlobalReference.buildingNames.SMALL);

    console.log('old', smallBuildCordinates);
    console.log('new', smBuildingCordinates);
    ...
    if(isInBuildingRange) { 
        console.log('IN SMALL RANGE');
        // draw / explode building
    }
}
